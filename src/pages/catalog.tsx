...
<body color="black">
    <header>
        ...
        <div className="logo">
            <img src={logo} srcSet="images/logo_1x.png 220w,
    ...
    <section className="container">
        <div className="screen">
            <img className="photo" src="images/shirt1_4x.png" srcSet="images/shirt1_1x.png 220w,
            ...
            <div className="text">    
                <span style={{
                    fontWeight: "bold",
                    color: "white",
                    }}><br />ФУТБОЛКА С ПРИНТОМ МОСФИЛЬМ </span>
                <span style={{
                    fontWeight: "bold",
                    color: "#ADFF00",
                    fontSize: "28px",
            ...
            <div className="screen">
            <img className="photo" src="images/shirt2_4x.png" 
        ...
        <div className="screen">
            <img className="photo" src="images/shirt6_4x.png"  srcSet="images/shirt6_1x.png 220w,
            ...
            <div className="text">    
                <span  style={{
                    fontWeight: "bold",
                    color: "white",
                    }}><br />ФУТБОЛКА С ОРНАМЕНТОМ ПЕЙСЛИ</span>
                <span style={{
                    fontWeight: "bold",
                    color: "#ADFF00",
                    fontSize: "28px",
        ...
        <section className="container">
        <div className="screen">
            <img className="photo" src="images/shirt4_4x.png" srcSet="images/shirt4_1x.png 220w,
        ...
        <div className="screen">
            <img className="photo" src="images/shirt7_4x.png"  srcSet="images/shirt7_1x.png 220w,
            ...
            <div className="text">    
                <span style={{
                    fontWeight: "bold",
                    color: "white",
                    }}><br />ЗИП ХУДИ ОВЕРСАЙЗ С ПРИНТОМ</span>
                <span style={{
                    fontWeight: "bold",
                    color: "#ADFF00",
                    fontSize: "28px",
            ...
            <div className="screen">
            <img className="photo" src="images/shirt8_4x.png" srcSet="images/shirt8_1x.png 220w,
            ...
            <div className="text">    
                <span style={{
                    fontWeight: "bold",
                    color: "white",
                    }}><br />ДЖИНСОВАЯ РУБАШКА С ДЛИННЫМ РУКАВОМ</span>
                <span style={{
                    fontWeight: "bold",
                    color: "#ADFF00",
                    fontSize: "28px",
